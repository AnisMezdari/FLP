	...
	jQuery.ajax({
	    ...
	    success: function(data){
	        ...
	        for(var i = 0 ; i < data.urlImage.length ; i++)
	        {
		        ...
		        append('<div class = "conteneurImageEvenement">'+
      			'<img src = "' + data.urlImage[i] + '" alt = "photo événement" class  = "imageEvenement" />'+
    		  	'<span  id= "' + urlSuppression + '" class="glyphicon glyphicon-remove fa-lg croixSuppression" > </span>'+
      			'</div>');
	        }
